      ...
      {totalSafe === 0 ? (
        ...
        <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-semibold text-emerald-400">
                    Best window: {formatHour(bestGroup[0])} – {formatHour((bestGroup[bestGroup.length - 1] + 1) % 24)}
                  </p>
          ...
          <div className="space-y-2">
            {groups.map((group, i) => {
              const Icon = getTimeOfDayIcon(group[0]);
              ...
              return (
                <div key={i} className="flex items-center gap-3 text-xs">
                  ...
                  <span className="font-medium">
                    {formatHour(group[0])} – {formatHour((group[group.length - 1] + 1) % 24)}
                  </span>
